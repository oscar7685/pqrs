...
<div class="container">
    ...
    <div class="wrapper">
        <div class="page-subtitle">
            <h3>Crear subproceso</h3>
        </div>

        <form id="fsubproceso" role="form" method="post"> 
            <div class="form-group">
                <label class="col-md-2 control-label">Subproceso</label>
                <div class="col-md-8">
                    <input type="text" class="form-control" placeholder="Subproceso" name="subproceso">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-md-offset-2 col-md-8">
                    <button type="submit" class="btn btn-default">Crear Subproceso</button>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(function() {
        if ($("#fsubproceso").length > 0) {
            $("#fsubproceso").validate({
                ...
                submitHandler: function() {
                    $.ajax({
                        url: 'Controller?accion=crearSubproceso2',
                        data: $("#fsubproceso").serialize(),
                        type: 'post',
                        success: function(data) {
                            $("div.dev-page-content").html(data);
                            document.location = "#subprocesos";
                        }
                    });
                }
            });
