                ...
                <span> 
                    <c:choose>
                        <c:when test="${1!=pageNumber}">
                            <a href="#paginacionM&numP=1" class="paginate_button current" >1</a>
                        </c:when>
                        <c:otherwise>
                            <a href="#paginacionM&numP=1" class="paginate_button">1</a>
                        </c:otherwise>        
                    </c:choose>   
                    <c:choose>
                        <c:when test="${numberOfPages gt 15}">
                            <c:if test="${pageNumber lt 5}">
                                <c:forEach begin="2" end="${5}" var="i">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a href="#paginacionM&numP=${i}" class="paginate_button">${i}</a>
                                        </c:otherwise>        
                                    </c:choose>       
                                </c:forEach>  
                            </c:if>
                            ...
                            <c:choose>
                                <c:when test="${pageNumber==numberOfPages}">
                                    <a href="#paginacionM&numP=${numberOfPages}" class="paginate_button current" >${numberOfPages}</a>
                                </c:when>
                                <c:otherwise>
                                    <a href="#paginacionM&numP=${numberOfPages}" class="paginate_button">${numberOfPages}</a>
                                </c:otherwise>        
                            </c:choose>                 
                        </c:when>
                        <c:otherwise>
