        ...
        <div class="table-responsive">
            ...
            <div class="dataTables_paginate paging_simple_numbers">
                <c:if test="${pageNumber gt 1}">
                    <a href="#paginacionC&numP=${pageNumber - 1}" class="paginate_button previous">Anterior</a>
                </c:if>
                <span> 
                    <c:choose>
                        <c:when test="${1!=pageNumber}">
                            <a href="#paginacionC&numP=1" class="paginate_button current" >1</a>
                        </c:when>
                        <c:otherwise>
                            <a href="#paginacionC&numP=1" class="paginate_button">1</a>
                        </c:otherwise>        
                    </c:choose>   
                    <c:choose>
                        <c:when test="${numberOfPages gt 15}">
                                ...
                                <c:forEach begin="2" end="${5}" var="i">
                                    <c:choose>
                                        <c:when test="${i!=pageNumber}">
                                            <a href="#paginacionC&numP=${i}" class="paginate_button current" >${i}</a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="#paginacionC&numP=${i}" class="paginate_button">${i}</a>
                                        </c:otherwise>        
                                    </c:choose>       
                                </c:forEach>  
                            </c:if>
                            ...
                            <c:choose>
                                <c:when test="${pageNumber==numberOfPages}">
                                    <a href="#paginacionC&numP=${numberOfPages}" class="paginate_button current" >${numberOfPages}</a>
                                </c:when>
                                <c:otherwise>
                                    <a href="#paginacionC&numP=${numberOfPages}" class="paginate_button">${numberOfPages}</a>
                                </c:otherwise>        
                            </c:choose>                 
                        </c:when>
                        <c:otherwise>
                ...
                <c:if test="${pageNumber lt numberOfPages}">
                    <a href="#paginacionC&numP=${pageNumber + 1}" class="paginate_button next">Siguiente</a>
                </c:if>
            </div>
        </div>
    </div>
