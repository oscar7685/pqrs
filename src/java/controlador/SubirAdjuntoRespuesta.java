 ...
 * @author Ususario
 */
public class SubirAdjuntoRespuesta extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idUltimaPQRS1 = (String) sesion.getAttribute("pqrs");
        ...
        try {
            ...
            for (FileItem item : items) {
                if (!item.isFormField()) {
                    ...
                    String str = request.getSession().getServletContext().getRealPath("/respuestas/");
                    ...
                    try {
                        ...
                        String aux = "{\"name\":\"" + fichero.getName()
                                + "\",\"size\":\"" + 2000 + "\",\"url\":\"/pqrs/respuestas/" + fichero.getName()
