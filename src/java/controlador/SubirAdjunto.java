        ...
        try {
            ...
            if (ficheros == null) {
                ...
                for (int i = 0; i < ficheros.length; i++) {
                    ...
                    if (!aux.equals("")) {
                        if (elemento2[0].equals("" + p.getIdpqrs())) {
                            aux += ",{\"name\":\"" + ficheros[i] + "\",\"size\":\"" + 2000 + "\",\"url\":\"/pqrs/adjuntos/" + ficheros[i] + "\",\"thumbnailUrl\":\"/pqrs/adjuntos/" + ficheros[i] + "\",\"deleteUrl\":\"/pqrs/SubirAdjunto?file=" + ficheros[i] + "\",\"deleteType\":\"DELETE\",\"type\":\"" + elementos[1] + "\"}";
                        }
                    } else {
